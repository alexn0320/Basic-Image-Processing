...
/*
    Various filters that can be used for convolution
*/
// box blur 
extern const double BOX_BLUR[3][3];
// gaussian blur 3x3 approximation
extern const double GAUSSIAN_BLUR_3X3[3][3];
// sobel filter for x axis
extern const double SOBEL_KX[3][3];
// sobel filter for y axis
extern const double SOBEL_KY[3][3];
...
extern void swap_positions(pos *p1, pos* p2);
